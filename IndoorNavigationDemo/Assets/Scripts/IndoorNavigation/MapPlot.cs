...
public class MapPlot : MonoBehaviour
{
    ...
    private void DraweLine(){
        if(c < ps.Count){
            var w = ps[c] - new Vector3(0,0,0);
            Ps.Add(w);
            pl = Ps.ToArray();
    ...
    private void addAP()
    {
        ...
        AP.transform.localPosition += new Vector3(0,425,0);
    }
    ...
    private void addNode()
    {
        ...
        nodes.transform.localPosition += new Vector3(0,425,0);
    }
    ...
    private void PositionP()
    {
        ...
        positions.transform.localPosition += new Vector3(0,425,0);
